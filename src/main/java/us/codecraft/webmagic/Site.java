...
public class Site {
     ...
     * Because urls are more a Spider's property than Site, move it to {@link SpiderOlder#addUrl(String...)}}
     *
     * @param startUrl
     * @return this
     * @see SpiderOlder#addUrl(String...)
     * @deprecated
     */
    ...
    /**
     * Add a url to start url.<br>
     * Because urls are more a Spider's property than Site, move it to {@link SpiderOlder#addRequest(Request...)}}
     *
     * @param startRequest
     * @return this
     * @see SpiderOlder#addRequest(Request...)
     * @deprecated
     */
